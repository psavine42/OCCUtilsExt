...
from OCC.TopAbs import TopAbs_IN, TopAbs_FACE
from OCC.TopExp import topexp, TopExp_Explorer
from OCC.TopoDS import TopoDS_Vertex, TopoDS_Face, TopoDS_Edge, TopoDS_Wire, TopoDS_Shape
...
from OCC.gp import gp_Pnt2d, gp_Dir, gp_Pnt, gp_Pln

from .base import BaseObject
from .edge import Edge
from .Construct import TOLERANCE, to_adaptor_3d, face_normal, \
