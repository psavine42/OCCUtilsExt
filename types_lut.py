...
from OCC.BRepExtrema import (BRepExtrema_IsVertex, BRepExtrema_IsOnEdge, BRepExtrema_IsInFace)
_bds_types_a = ['vertex', 'edge', 'face']
_bds_types_b = [BRepExtrema_IsVertex, BRepExtrema_IsOnEdge, BRepExtrema_IsInFace]

brep_extrema_lut = EnumLookup(_bds_types_a, _bds_types_b)
